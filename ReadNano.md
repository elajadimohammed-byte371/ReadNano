...
Feel free to connect if you are working on nanoscience, computational physics, or related fields!
...
# Used as an introductory computational model for nanoscale heat transfer
...
# Parameters
L = 1e-6        # Length of the material in meters (1 micron)
Nx = 200        # Number of spatial points
x = np.linspace(0, L, Nx)
alpha = 1e-7    # Thermal diffusivity (m^2/s)
t_max = 1e-9    # Simulation time (s)
...
# Solve using the method of lines
solution = solve_ivp(
    thermal_transport,
    [0, t_max],
    u0,
